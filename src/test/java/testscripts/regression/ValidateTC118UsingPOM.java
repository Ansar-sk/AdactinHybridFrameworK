...
public class ValidateTC118UsingPOM extends BaseTest {
	...
	public void Validatesearchpage(HashMap<String, String> testdatamap) {
		...
		bh.book();
		String ordernumber =bh.getorderid();
		bh.getiternary();
		
		sh.enterorderid(ordernumber);
		sh.searchorder();
		sh.validateorder(testdatamap.get("Results found"));
	}

	@DataProvider
	public Object[][] datafromexcel() {
		Object[][] data = new Object[1][1];
		data[0][0] = UtilKit.getExcelData("TC-118");
		return data;
	}
