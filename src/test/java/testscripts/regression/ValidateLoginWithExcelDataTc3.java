...
public class ValidateLoginWithExcelDataTc3 extends BaseTest {
...
Assert.assertEquals(driver.findElement(By.xpath("//input[@name='hotel_name_0']")).getAttribute("value"), "Hotel Creek");
